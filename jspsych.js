...
/* TODO abstract this into a jspsych.config.js file
   currently, the selected ones are only the plugins that 
   Sandbox's predictive-affect project uses */
   const activePlugins = [
    // "jspsych-RDK.js",
    ...
    require("./plugins/jspsych-call-function.js"),
    ...
    require("./plugins/jspsych-html-double-slider-response.js"),
    // "jspsych-iat-html.js",
    // "jspsych-iat-image.js",
    // "jspsych-image-button-response.js",
    require("./plugins/jspsych-image-keyboard-response.js"),
    require("./plugins/jspsych-instructions.js"),
    ...
    require("./plugins/jspsych-survey-text.js"),
    // "jspsych-video.js",
